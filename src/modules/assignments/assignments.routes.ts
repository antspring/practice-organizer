...
import { getCohortAssignment, getMyCohortAssignment, upsertCohortAssignment } from './assignments.controller';

const assignmentsRouter = Router();

assignmentsRouter.use(authenticate);
assignmentsRouter.get('/cohorts/:cohortId/me', authorize(UserRole.student), getMyCohortAssignment);
